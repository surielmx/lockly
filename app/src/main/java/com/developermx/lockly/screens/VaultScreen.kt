...
fun VaultFileItem(
    ...
    Row(
        ...
        val originalFileName = file.originalName.removeSuffix(".enc")
        val icon = getIconForFile(originalFileName)
        Icon(icon, contentDescription = originalFileName, tint = MaterialTheme.colorScheme.onSurface)
